...
base_datos = sqlite3.connect('historial.bd')
...
def mostrar_historial(ventana):
    boton_eliminar_historial = Button(ventana, text='Eliminar Historial', command= lambda: eliminar_historial(ventana), font=('Arial',14))
    boton_eliminar_historial.grid(row='7', column='5')
    ...
    texto_mostrar = Label(ventana, text='Historial:', bg='black', fg='white',font=('Arial',22))
    ...
    for registro in historial:
        ...
        etiqueta_cuenta = Label(ventana, text=f'{cuenta}', bg='black', fg='white',font=('Arial',14))
        etiqueta_resultado = Label(ventana, text=f'Resultado: {resultado}', bg='black', fg='white',font=('Arial',14))
